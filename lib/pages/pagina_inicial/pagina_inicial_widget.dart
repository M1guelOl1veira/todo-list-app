        ...
        body: SafeArea(
          ...
          child: Row(
            ...
            children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  FFAppState().excluiEditaOpen =
                                      !(FFAppState().excluiEditaOpen ?? true);
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 70.0,
                                ...
                                child: Container(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewItemsByTodoListIdItemListTodoListIdPostResponse =
                                          snapshot.data!;

                                      return Builder(
                                        builder: (context) {
                                          final listItems = getJsonField(
                                            listViewItemsByTodoListIdItemListTodoListIdPostResponse
                                                .jsonBody,
                                            r'''$[:].titulo''',
              ...
              if (FFAppState().excluiEditaOpen == true)
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.all(24.0),
                    child: Container(
